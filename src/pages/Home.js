        ...
        <>
            <div className=" my-4 flex items-center flex-col gap-y-5">
                ...
                <div className=" mr-auto">
                    ...
                    <p className="text-white text-justify text-2xl my-5">Discover an innovative way to mount your 360° <br/>photos in order to highlight them and show <br/>them to your loved ones!<br/>Add hotspots, points of interest, images, and more...</p>
                </div>
                <img className="ml-36" src="../test3.png" alt=""></img>
                </Row>
                
                
                <h2 className="text-white font-bold font-body mr-auto text-2xl mb-4">Community projects</h2>
            </div>
            <div className="">
                <Carousel/>
            </div>
